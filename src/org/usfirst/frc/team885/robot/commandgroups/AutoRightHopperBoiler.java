...
/**
 * On boiler side of field, right in this case, collect from hopper and shoot into boiler
 */
public class AutoRightHopperBoiler extends CommandGroup {

    public AutoRightHopperBoiler() {
        // Go forward 77"
    	// Turn antoclockwise 90 degrees
