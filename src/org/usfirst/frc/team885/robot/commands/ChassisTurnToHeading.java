...
/**
 * Turn to a heading without resetting heading PID (not tested)
 */
public class ChassisTurnToHeading extends Command {
	
	private double degrees;

    public ChassisTurnToHeading(double degrees) {
    ...
    protected void initialize() {
    	Robot.chassis.startHeadingPID(degrees);
    }
